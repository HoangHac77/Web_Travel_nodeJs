      ...
      <body class="datepicker_mobile_full">
        <div id="page">
          <header class="header menu_fixed">
            ...
            <ul id="top_menu">
              <li>
                <a href="cart-1.html" class="cart-menu-btn" title="Cart">
                  <strong>4</strong>
                </a>
              </li>
              <li>
              ...
              <ul>
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <span>
                        <a href="#0">Sliders - Parallax</a>
                      </span>
                      <ul>
                        <li>
                          <a href="index-11.html">Revolution Slider 1</a>
                        </li>
                        <li>
                          <a href="index-18.html">Revolution Slider 2</a>
                        </li>
                        <li>
                          <a href="index-2.html">Flex Slider</a>
                        </li>
                        <li>
                          <a href="index-4.html">Layer Slider</a>
                        </li>
                        <li>
                          <a href="index-12.html">Parallax Youtube</a>
                        </li>
                        <li>
                          <a href="index-13.html">Parallax Vimeo</a>
                        </li>
                        <li>
                          <a href="index-14.html">Parallax Mp4 Video</a>
                        </li>
                        <li>
                          <a href="index-15.html">Parallax Video Fullscreen</a>
                        </li>
                        <li>
                          <a href="index-16.html">Parallax Image</a>
                        </li>
                      </ul>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="index-17.html">Text Rotator</a>
                    </li>
                    <li>
                      <a href="index-3.html">Video Fallback Mobile</a>
                    </li>
                    <li>
                      <a href="index-5.html">Search 2</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="index-7.html">Search 4</a>
                    </li>
                    <li>
                      <a href="index-6.html">GDPR (EU law)</a>
                    </li>
                    <li>
                      <a href="index-8.html">Address Autocomplete</a>
                    </li>
                    <li>
                      <a href="index-9.html">Home AirBnb</a>
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="tours-grid-sidebar.html">
                            Tours Grid Sidebar
                          </a>
                        </li>
                        <li>
                          <a href="tours-grid-sidebar-2.html">
                            Tours Grid Sidebar 2
                          </a>
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="tours-list-sidebar.html">
                            Tours List Sidebar
                          </a>
                        </li>
                        <li>
                          <a href="tours-list-sidebar-2.html">
                            Tours List Sidebar 2
                          </a>
                        </li>
                        <li>
                    ...
                    <li>
                      <a href="tours-half-screen-map.html">
                        Tours Half Screen Map
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <span>
                        <a href="#0">Open Street Map</a>
                      </span>
                      <ul>
                        <li>
                          <a href="tours-half-screen-map-leaflet.html">
                            Tours Half Screen Map
                          </a>
                        </li>
                        <li>
                          <a href="tours-list-isotope-leaflet.html">
                            Tours Grid Isotope
                          </a>
                        </li>
                        <li>
                          <a href="tours-list-sidebar-leaflet.html">
                            Tours Grid Sidebar
                          </a>
                        </li>
                        <li>
                          <a href="tours-list-sidebar-2-leaflet.html">
                            Tours Grid Sidebar 2
                          </a>
                        </li>
                        <li>
                          <a href="tours-list-leaflet.html">
                            Tours Grid Simple
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="tour-detail-leaflet.html">Tour Detail</a>
                        </li>
                      </ul>
                    </li>
                  </ul>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="hotels-grid-sidebar.html">
                            Hotel Grid Sidebar
                          </a>
                        </li>
                        <li>
                    ...
                    <li>
                      <span>
                        <a href="#0">Hotel List</a>
                      </span>
                      <ul>
                        <li>
                          <a href="hotels-list-isotope.html">
                            Hotel List Isotope
                          </a>
                        </li>
                        <li>
                    ...
                    <li>
                      <a href="hotels-half-screen-map.html">
                        Hotel Half Screen Map
                      </a>
                    </li>
                    <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="restaurants-grid.html">
                            Restaurant Grid simple
                          </a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="restaurants-list.html">
                            Restaurant List Simple
                          </a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      <a href="restaurants-half-screen-map.html">
                        Half Screen Map
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="restaurant-detail-2.html">
                        Restaurant Time Picker
                      </a>
                    </li>
                  </ul>
                </li>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="bootstrap-modal.html">
                        Bootstrap Modal{" "}
                        <strong class="badge badge-danger">New!</strong>
                      </a>
                    </li>
                    <li>
                      <a href="modal-version-2.html">
                        Another Modal{" "}
                        <strong class="badge badge-danger">New!</strong>
                      </a>
                    </li>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="menu-options.html">Menu Position Options</a>
                    </li>
                    <li>
                      <a href="tour-detail-singlemonth-datepicker.html">
                    ...
                    <li>
                      <a href="hamburgers.html">Animated Hamburgers</a>
                    </li>
                  </ul>
                </li>
                <li>
                  <span>
                    <a href="https://1.envato.market/DmbYj" target="_parent">
                      Buy template
                    </a>
                  </span>
                </li>
          ...
          <main>
            ...
            <div class="container container-custom margin_80_0">
              ...
              <div id="reccomended" class="owl-carousel owl-theme">
                <div class="item">
                  <div class="box_grid">
                    ...
                    <div class="wrapper">
                      <h3>
                        <a href="tour-detail.html">Arc Triomphe</a>
                      </h3>
                      <p>
                ...
                <div class="item">
                  <div class="box_grid">
                    ...
                    <div class="wrapper">
                      <h3>
                        <a href="tour-detail.html">Versailles</a>
                      </h3>
                      <p>
                        Id placerat tacimates definitionem sea, prima quidam vim
                        no. Duo nobis persecuti cu.
                ...
                <div class="item">
                  <div class="box_grid">
                    ...
                    <div class="wrapper">
                      <h3>
                        <a href="tour-detail.html">Pompidue Museum</a>
                      </h3>
                      <p>
                        Id placerat tacimates definitionem sea, prima quidam vim
                        no. Duo nobis persecuti cu.
                    ...
                    <ul>
                      <li>
                        <i class="icon_clock_alt"></i> 2h 30min
                      </li>
                      <li>
                        <div class="score">
                          <span>
                ...
                <div class="item">
                  <div class="box_grid">
                    ...
                    <div class="wrapper">
                      <h3>
                        <a href="tour-detail.html">Tour Eiffel</a>
                      </h3>
                      <p>
                        Id placerat tacimates definitionem sea, prima quidam vim
                        no. Duo nobis persecuti cu.
              ...
              <p class="btn_home_align">
                <a href="tours-grid-isotope.html" class="btn_1 rounded">
                  View all Tours
                </a>
              </p>
              <hr class="large" />
            ...
            <div class="bg_color_1">
              <div class="container margin_80_55">
                ...
                {/* <!-- /row --> */}
                <p class="btn_home_align">
                  <a href="blog.html" class="btn_1 rounded">
                    View all news
                  </a>
                </p>
              </div>
            ...
            <div class="call_section">
              <div class="container clearfix">
                <div
                  class="col-lg-5 col-md-6 float-end wow position-relative"
                  data-wow-offset="250"
                >
                  <div class="block-reveal">
                    ...
                    <div class="box_1">
                      ...
                      <p>
                        ...
                        disputationi. Menandri erroribus cu per, duo solet
                        congue ut.{" "}
                      </p>
            ...
            <div class="container margin_60_35">
              <div class="row">
                <div class="col-lg-5 col-md-12 pe-5">
                  ...
                  <p>
                    Mea nibh meis philosophia eu. Duis legimus efficiantur ea
                    sea. Id placerat tacimates definitionem sea, prima quidam
                    vim no. Duo nobis persecuti cu. Nihil facilisi indoctum an
                    vix, ut delectus expetendis vis.
                  </p>
                  <div class="follow_us">
                    <ul>
                      <li>Follow us</li>
                  ...
                  <ul class="contacts">
                    <li>
                      <a href="tel://61280932400">
                        <i class="ti-mobile"></i> + 61 23 8093 3400
                      </a>
                    </li>
                    <li>
                      <a href="mailto:info@Panagea.com">
                        <i class="ti-email"></i> info@Panagea.com
                      </a>
                    </li>
                  </ul>
                  <div id="newsletter">
