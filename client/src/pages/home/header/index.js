  ...
  return (
    <>
        <header className="header menu_fixed">
            ...
            <div id="logo">
			<a href="index.html">
				<img src="" width="150" height="36" alt="" className="logo_normal"/>
				<img src="" width="150" height="36" alt="" className="logo_sticky"/>
			</a>
		    </div>
            <ul id="top_menu">
			...
			<ul>
				<li><span><a href="#0">Home</a></span>
					<ul>
						...
						<li><a href="index-19.html">KenBurns Slider <strong className="badge badge-danger">New!</strong></a></li>
				...
				<li><span><a href="#0">Extra</a></span>
					<ul>
						<li><a href="html_rtl/index.html">RTL Version <strong className="badge badge-danger">New!</strong></a></li>
